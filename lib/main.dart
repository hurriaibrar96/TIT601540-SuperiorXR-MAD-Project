...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    \\MAD LAB 12
      \\CONNECTING FIREBASE TO MOBILE APP
      \\BY Javeria Nawal
      import 'package:flutter/material.dart';
...
void main() async {
  ...
  await Firebase.initializeApp(
    options: const FirebaseOptions(
      apiKey: "AIzaSyD4eJqO9hHbFtVa5SsAXRJvL4c0eAf7JXY",
      appId: "1:832561075061:web:b9e95878976d368ad1f93c",
      messagingSenderId: "832561075061",
      projectId: "lab12app-9e84a",
      authDomain: "lab12app-9e84a.firebaseapp.com",
      storageBucket: "lab12app-9e84a.firebasestorage.app",
    ),
  );
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext c) {
    return Scaffold(
      appBar: AppBar(title: const Text("Campus Guide App")),
      body: Column(
        children: [
          TextField(
            controller: con,
            decoration: const InputDecoration(
              hintText: "Enter place (Library, Cafe...)",
            ),
          ),
          ElevatedButton(
            onPressed: addPlace,
          ...
          Expanded(
            child: StreamBuilder(
              stream: db.collection("places").snapshots(),
              builder: (c, s) {
